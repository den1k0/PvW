...
give @s minecraft:white_wool[minecraft:consumable={consume_seconds:0.05,sound:'item.bundle.remove_one'},minecraft:enchantment_glint_override=true,custom_name=["",{"text":"Press RMB To Call In A Gunship","italic":false,"color":"green"}],custom_data={dontdrop:1b}] 1
tag @s add gunship
title @s actionbar {"text":"You got GUNSHIP!","color":"gold"}
